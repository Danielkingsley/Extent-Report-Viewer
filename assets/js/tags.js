...
(function () {
  ...
  searchT.addEventListener('input', filterDrill);
  filterStatusT.addEventListener('change', filterDrill);
  btnResetT.addEventListener('click', () => { searchT.value = ''; filterStatusT.value = ''; filterDrill(); });
  btnExportT.addEventListener('click', () => window.exportCSV(filteredDrill, 'tag-export.csv'));
