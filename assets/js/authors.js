...
(function () {
  ...
  if (searchA)       searchA.addEventListener('input', filterDrill);
  if (filterStatusA) filterStatusA.addEventListener('change', filterDrill);
  if (btnResetA)     btnResetA.addEventListener('click', () => { searchA.value = ''; filterStatusA.value = ''; filterDrill(); });
